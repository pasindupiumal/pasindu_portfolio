...
const ADDITIONAL_PROJECTS = [
  ...
  },
  {
    ...
    active: true,
    description: "OneLearning is a powerful Chrome extension that helps you effortlessly import your saved LinkedIn posts and organize them with custom tags and notes. It transforms your LinkedIn saved content into a searchable, well-organized knowledge base, making it easy to revisit and reference valuable insights whenever you need them.",
    technologies: ["React.js", "Chrome Extension API", "IndexedDB", "Chrome Storage", "TailwindCSS", "Manifest V3"],
  ...
  },
  {
    ...
    active: true,
    description: "Censor AI is a smart Chrome extension that revolutionizes email writing on Gmail. Simply type your message, and Censor AI suggests a professionally rewritten version using OpenAI's powerful API. You can send the AI-enhanced email instantly or fine-tune it before sending. Perfect for crafting professional, clear, or friendly emails with ease—making email communication smarter and more efficient.",
    technologies: ["Chrome Extension API", "OpenAI API", "Gmail Integration", "JavaScript", "TailwindCSS", "Manifest V3"],
    links: [
      {
        type: "Store",
        href: "https://chromewebstore.google.com/detail/censor/elgfhammpjfmmgiflpjbohhbimlfdimm",
  ...
  },
  {
    ...
    active: true,
    description: "Link Shortener is a sleek Chrome extension that instantly shrinks the URL you're currently visiting with a stunning modern UI. It offers comprehensive URL management with features including history tracking, social sharing, QR code generation, favorites list, and custom URL shortening. Perfect for content creators, marketers, and anyone who needs quick, organized access to shortened links with a beautiful, intuitive interface.",
    technologies: ["Chrome Extension API", "URL Shortening API", "QR Code Generation", "Chrome Storage", "JavaScript", "TailwindCSS", "Manifest V3"],
    image: "shortner.webp",
    category: "extensions" as TabType,
  },
  {
